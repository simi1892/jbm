...
export default function MobileHeader(props: Omit<HeaderProps, "sticky">) {
  ...
  return (
    <div class="relative block text-lg font-bold text-gray-700 dark:text-gray-300 sm:hidden">
      ...
      <div class="absolute top-12 w-full bg-gray-100 dark:bg-gray-700">
        <div
          class={`divide-y divide-gray-300 overflow-hidden transition-all duration-300 dark:divide-gray-600 ${
